...
/**
 * A button to share content on Facebook. Tapping the receiver will invoke the
 * {@link com.facebook.share.widget.ShareDialog} with the attached shareContent.
 */
public final class ShareButton extends ShareButtonBase {
	private static final int DEFAULT_REQUEST_CODE = CallbackManagerImpl.RequestCodeOffset.Share
			.toRequestCode();
	...
	public ShareButton(final Context context, final AttributeSet attrs,
		...
		super(context, attrs, defStyleAttr,
				AnalyticsEvents.EVENT_SHARE_BUTTON_CREATE, DEFAULT_REQUEST_CODE);
	}

	@Override
	protected int getDefaultStyleResource() {
		return ResourceUtil.getStyleId("com_facebook_button_share");
	}
		...
		return new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (ShareButton.this.getFragment() != null) {
					dialog = new ShareDialog(ShareButton.this.getFragment(),
							getRequestCode());
				} else {
