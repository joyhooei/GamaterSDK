...
public class WebDialogParameters {
	...
	public static Bundle create(AppGroupCreationContent appGroupCreationContent) {
		...
		Utility.putNonEmptyString(webParams,
				...
				appGroupCreationContent.getAppGroupPrivacy().toString()
	...
	public static Bundle create(GameRequestContent gameRequestContent) {
		...
		Utility.putNonEmptyString(webParams, "frictionless", "1");
		Utility.putNonEmptyString(webParams,
				ShareConstants.WEB_DIALOG_PARAM_MESSAGE,
				gameRequestContent.getMessage());
		Utility.putNonEmptyString(webParams,
				ShareConstants.WEB_DIALOG_PARAM_TO, gameRequestContent.getTo());
		Utility.putNonEmptyString(webParams,
		...
		if (gameRequestContent.getActionType() != null) {
			Utility.putNonEmptyString(
					...
					gameRequestContent.getActionType().toString()
							.toLowerCase(Locale.ENGLISH));
		}
		Utility.putNonEmptyString(webParams,
		...
		if (gameRequestContent.getFilters() != null) {
			Utility.putNonEmptyString(webParams,
					ShareConstants.WEB_DIALOG_PARAM_FILTERS, gameRequestContent
							.getFilters().toString()
							.toLowerCase(Locale.ENGLISH));
		}
		Utility.putCommaSeparatedStringList(webParams,
	...
	public static Bundle create(ShareLinkContent shareLinkContent) {
		...
		Utility.putUri(params, ShareConstants.WEB_DIALOG_PARAM_HREF,
	...
	public static Bundle create(ShareOpenGraphContent shareOpenGraphContent) {
		...
		Utility.putNonEmptyString(params,
				ShareConstants.WEB_DIALOG_PARAM_ACTION_TYPE,
				shareOpenGraphContent.getAction().getActionType());

		try {
			JSONObject ogJSON = ShareInternalUtility
					.toJSONObjectForWeb(shareOpenGraphContent);
			ogJSON = ShareInternalUtility.removeNamespacesFromOGJsonObject(
					ogJSON, false);
			if (ogJSON != null) {
				Utility.putNonEmptyString(params,
			...
			throw new FacebookException(
					"Unable to serialize the ShareOpenGraphContent to JSON", e);
		}
