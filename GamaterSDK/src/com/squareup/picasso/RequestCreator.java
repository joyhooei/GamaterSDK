...
public class RequestCreator {
	 ...
	 * inPurgeable only affects the former.
	 * <p>
	 * <em>Note</em>: as of API level 21 (Lollipop), the inPurgeable field is
	...
	public Bitmap get() throws IOException {
		...
		Action action = new GetAction(picasso, finalData, memoryPolicy,
				networkPolicy, tag, key);
	...
	public void fetch(Callback callback) {
		...
		if (data.hasImage()) {
			...
			Action action = new FetchAction(picasso, request, memoryPolicy,
	...
	public void into(Target target) {
		...
		Action action = new TargetAction(picasso, target, request,
				memoryPolicy, networkPolicy, errorDrawable, requestKey, tag,
				errorResId);
	...
	public void into(RemoteViews remoteViews, int viewId, int notificationId,
		...
		Request request = createRequest(started);
		String key = createKey(request, new StringBuilder()); // Non-main thread
																// needs own
																// builder.

		RemoteViewsAction action = new NotificationAction(picasso, request,
				remoteViews, viewId, notificationId, notification,
				notificationTag, memoryPolicy, networkPolicy, key, tag,
				errorResId);
	...
	public void into(RemoteViews remoteViews, int viewId, int[] appWidgetIds) {
		...
		RemoteViewsAction action = new AppWidgetAction(picasso, request,
				remoteViews, viewId, appWidgetIds, memoryPolicy, networkPolicy,
				key, tag, errorResId);
