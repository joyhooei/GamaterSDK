...
public final class GameRequestContent implements ShareModel {
	...
	/**
	 * Gets the open graph id of the object that action type will be performed
	 * on
	 */
	...
	public static class Builder implements
			ShareModelBuilder<GameRequestContent, Builder> {
		...
		/**
		 * Sets the message users receiving the request will see. The maximum
		...
		/**
		 * Sets the open graph id of the object that action type will be
		 * performed on Only valid (and required) for ActionTypes SEND, ASKFOR
		 */
		...
		public Builder readFrom(final GameRequestContent content) {
			...
			return this.setMessage(content.getMessage()).setTo(content.getTo())
					.setTitle(content.getTitle()).setData(content.getData())
		...
		public Builder readFrom(final Parcel parcel) {
			return this.readFrom((GameRequestContent) parcel
					.readParcelable(GameRequestContent.class.getClassLoader()));
		}
	}
}
