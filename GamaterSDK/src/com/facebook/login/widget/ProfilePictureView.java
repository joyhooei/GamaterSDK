...
public class ProfilePictureView extends FrameLayout {
	 ...
	 * into when certain errors occur.
	 *
	 ...
	 * that is properly sized for the layout dimensions
	 */
	@Override
	...
	private void parseAttributes(AttributeSet attrs) {
		TypedArray a = getContext()
				.obtainStyledAttributes(
						attrs,
						ResourceUtil
								.getStyleableIntArray("com_facebook_profile_picture_view"));
		setPresetSize(a
				.getInt(ResourceUtil
						.getStyleableIntArrayIndex("com_facebook_profile_picture_view_preset_size"),
						CUSTOM));
		isCropped = a
				.getBoolean(
						ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_profile_picture_view_is_cropped"),
	...
	private void setBlankProfilePicture() {
		...
		if (customizedDefaultProfilePicture == null) {
			int blankImageResource = isCropped() ? ResourceUtil
					.getDrawableId("com_facebook_profile_picture_blank_square")
					: ResourceUtil
							.getDrawableId("com_facebook_profile_picture_blank_portrait");
	...
	private void sendImageRequest(boolean allowCachedResponse) {
		...
		// prevent
		// accidental cancellation of the new request. This could happen if the
		// URL and
	...
	private int getPresetSizeInPixels(boolean forcePreset) {
		...
		case SMALL:
			dimensionId = ResourceUtil
					.getDimenId("com_facebook_profilepictureview_preset_size_small");
			break;
		case NORMAL:
			dimensionId = ResourceUtil
					.getDimenId("com_facebook_profilepictureview_preset_size_normal");
			break;
		case LARGE:
			dimensionId = ResourceUtil
					.getDimenId("com_facebook_profilepictureview_preset_size_large");
			break;
		case CUSTOM:
			if (!forcePreset) {
