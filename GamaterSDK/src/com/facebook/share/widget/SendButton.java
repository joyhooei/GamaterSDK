...
/**
 * A button to share content through Messenger. Tapping the receiver will invoke
 * the {@link com.facebook.share.widget.MessageDialog} with the attached
 * shareContent.
 */
public final class SendButton extends ShareButtonBase {
	private static final int DEFAULT_REQUEST_CODE = CallbackManagerImpl.RequestCodeOffset.Message
			.toRequestCode();
	...
	public SendButton(final Context context, final AttributeSet attrs,
		...
		super(context, attrs, defStyleAttr,
				AnalyticsEvents.EVENT_SEND_BUTTON_CREATE, DEFAULT_REQUEST_CODE);
	}

	@Override
	protected int getDefaultStyleResource() {
		return ResourceUtil.getStyleId("com_facebook_button_send");
	}
		...
		return new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (SendButton.this.getFragment() != null) {
					dialog = new MessageDialog(SendButton.this.getFragment(),
							getRequestCode());
				} else {
