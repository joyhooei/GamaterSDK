...
public class FloatMenu extends FrameLayout {
	...
	protected void dispatchDraw(Canvas canvas) {
		if (mainView != null && mainView.getClipPath() != null) {
			mainView.setClipPath(makePath(menuScroll.getMeasuredWidth(),
					getHeight(), getHeight() / 2 + 1));
	...
	public void showAnim(boolean isLeft) {
		...
		ScaleAnimation a1 = new ScaleAnimation(0f, 1.1f, 0f, 1f, Animation.RELATIVE_TO_SELF, pivotX,
				Animation.RELATIVE_TO_SELF, pivotY);
		a1.setDuration(150);
		final ScaleAnimation a2 = new ScaleAnimation(1.1f, 1f, 1f, 1f, Animation.RELATIVE_TO_SELF, pivotX,
				Animation.RELATIVE_TO_SELF, pivotY);
		a2.setDuration(100);
	...
	public void hideAnim(boolean isLeft) {
		setItemVisible(View.INVISIBLE);
		float pivotX = isLeft ? 0.1f : 0.9f, pivotY = 0.5f;
		ScaleAnimation a1 = new ScaleAnimation(1f, 0f, 1f, 0f, Animation.RELATIVE_TO_SELF, pivotX,
				Animation.RELATIVE_TO_SELF, pivotY);
		a1.setDuration(150);
		a1.setAnimationListener(new AnimationListener() {
			@Override
