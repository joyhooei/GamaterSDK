...
public class LoginFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		request = (LoginClient.Request) getActivity().getIntent()
				.getParcelableExtra(EXTRA_REQUEST);

		loginClient
				.setOnCompletedListener(new LoginClient.OnCompletedListener() {
					@Override
	...
	public View onCreateView(LayoutInflater inflater,
		...
		final View view = inflater.inflate(
				ResourceUtil.getLayoutId("com_facebook_login_fragment"),
				container, false);

		loginClient
				.setBackgroundProcessingListener(new LoginClient.BackgroundProcessingListener() {
					@Override
					public void onBackgroundProcessingStarted() {
						view.findViewById(
								ResourceUtil
										.getId("com_facebook_login_activity_progress_bar"))
	...
	public void onPause() {
		...
		getActivity().findViewById(
				ResourceUtil.getId("com_facebook_login_activity_progress_bar"))
				.setVisibility(View.GONE);
	}
