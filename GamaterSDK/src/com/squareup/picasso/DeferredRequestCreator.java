...
class DeferredRequestCreator implements ViewTreeObserver.OnPreDrawListener {
	...
	DeferredRequestCreator(RequestCreator creator, ImageView target,
		...
		// Since the view on which an image is being requested might not be
		// attached to a hierarchy,
		// defer adding the pre-draw listener until the view is attached. This
		// works around a platform
		// behavior where a global, dummy VTO is used until a real one is
		// available on attach.
