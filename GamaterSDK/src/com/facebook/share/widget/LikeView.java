...
/**
 * This class provides the UI for displaying the Facebook Like button and its
...
public class LikeView extends FrameLayout {
	...
	/**
	 * Encapsulates the valid values for the facebook:object_type attribute for
	 * a LikeView
	 */
	public enum ObjectType {
		...
		/**
		 * Indicates that the object id set on this LikeView is an Open Graph
		 * object
		 */
	...
	/**
	 * Encapsulates the valid values for the facebook:style attribute for a
	 * LikeView
	 */
	public enum Style {
		/**
		 * Setting the attribute to this value will display the button and a
		 * sentence near it that describes the social sentence for the
		 * associated object.
		 * <p/>
		 * This is the default value
		 */
		...
		/**
		 * Setting the attribute to this value will display the button by
		 * itself, with no other components
		 */
		BUTTON("button", 1),

		/**
		 * Setting the attribute to this value will display the button and a box
		 * near it with the number of likes for the associated object
		 */
	...
	/**
	 * Encapsulates the valid values for the facebook:horizontal_alignment
	 * attribute for a LikeView.
	 */
	public enum HorizontalAlignment {
		/**
		 * Setting the attribute to this value will center the button and
		 * auxiliary view in the parent view.
		 * <p/>
		 * This is the default value
		 */
		CENTER("center", 0),
		...
		/**
		 * Setting the attribute to this value will left-justify the button and
		 * auxiliary view in the parent view.
		 */
		LEFT("left", 1),

		/**
		 * Setting the attribute to this value will right-justify the button and
		 * auxiliary view in the parent view. If the
		 * facebook:auxiliary_view_position is set to INLINE, then the auxiliary
	...
	/**
	 * Encapsulates the valid values for the facebook:auxiliary_view_position
	 * attribute for a LikeView.
	 */
	public enum AuxiliaryViewPosition {
		/**
		 * Setting the attribute to this value will put the social-sentence or
		 * box-count below the like button. If the facebook:style is set to
		 * BUTTON, then this has no effect.
		 * <p/>
		 * This is the default value
		 */
		BOTTOM("bottom", 0),
		...
		/**
		 * Setting the attribute to this value will put the social-sentence or
		 * box-count inline with the like button. The auxiliary view will be to
		 * the left of the button if the facebook:horizontal_alignment is set to
		 * RIGHT. In all other cases, it will be to the right of the button. If
		 * the facebook:style is set to BUTTON, then this has no effect.
		 */
		INLINE("inline", 1),

		/**
		 * Setting the attribute to this value will put the social-sentence or
		 * box-count above the like button. If the facebook:style is set to
		 * BUTTON, then this has no effect.
		 */
		TOP("top", 2);
	...
	/**
	 * Sets the associated object ID for this LikeView. Can be changed during
	 * runtime.
	 * 
	 * @param objectId
	 ...
	 *
	 * @param likeViewStyle
	 *            Should be either LikeView.STANDARD, LikeView.BUTTON or
	 *            LikeView.BOX_COUNT
	 */
	...
	/**
	 * Sets the facebook:auxiliary_view_position for this LikeView. Can be
	 * changed during runtime.
	 *
	 * @param auxiliaryViewPosition
	 *            Should be either LikeView.TOP, LikeView.INLINE or
	 *            LikeView.BOTTOM
	 */
	public void setAuxiliaryViewPosition(
			AuxiliaryViewPosition auxiliaryViewPosition) {
		auxiliaryViewPosition = auxiliaryViewPosition != null ? auxiliaryViewPosition
				: AuxiliaryViewPosition.DEFAULT;
	...
	/**
	 * Sets the facebook:horizontal_alignment for this LikeView. Can be changed
	 * during runtime.
	 *
	 * @param horizontalAlignment
	 *            Should be either LikeView.LEFT, LikeView.CENTER or
	 *            LikeView.RIGHT
	 */
	public void setHorizontalAlignment(HorizontalAlignment horizontalAlignment) {
		horizontalAlignment = horizontalAlignment != null ? horizontalAlignment
	...
	/**
	 * Sets the facebook:foreground_color for this LikeView. Can be changed
	 * during runtime. The color is only used for the social sentence text.
	 *
	 * @param foregroundColor
	 *            And valid android.graphics.Color value.
	 */
	...
	/**
	 * Sets the parent Fragment which is hosting this LikeView. This allows the
	 * LikeView to be embedded inside a Fragment, and will allow the fragment to
	 * receive the
	 * {@link Fragment#onActivityResult(int, int, android.content.Intent)
	 * onActivityResult} call rather than the Activity, upon completion of Likes
	 * from this view.
	 *
	 * @param fragment
	 *            Fragment that is hosting the LikeView.
	 */
	...
	private void parseAttributes(AttributeSet attrs) {
		...
		TypedArray a = getContext().obtainStyledAttributes(attrs,
				ResourceUtil.getStyleableIntArray("com_facebook_like_view"));
		if (a == null) {
			return;
		}
		...
		objectId = Utility
				.coerceValueIfNullOrEmpty(
						a.getString(ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_like_view_object_id")),
						null);
		objectType = ObjectType
				.fromInt(a.getInt(
						ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_like_view_object_type"),
						ObjectType.DEFAULT.getValue()));
		likeViewStyle = Style.fromInt(a.getInt(ResourceUtil
				.getStyleableIntArrayIndex("com_facebook_like_view_style"),
				Style.DEFAULT.getValue()));
		if (likeViewStyle == null) {
			throw new IllegalArgumentException(
					"Unsupported value for LikeView 'style'");
		}

		auxiliaryViewPosition = AuxiliaryViewPosition
				.fromInt(a.getInt(
						ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_like_view_auxiliary_view_position"),
		...
		horizontalAlignment = HorizontalAlignment
				.fromInt(a.getInt(
						ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_like_view_horizontal_alignment"),
		...
		foregroundColor = a
				.getColor(
						ResourceUtil
								.getStyleableIntArrayIndex("com_facebook_like_view_foreground_color"),
						NO_FOREGROUND_COLOR);

		a.recycle();
	}

	// If attributes were present, parseAttributes MUST be called before
	// initialize() to ensure
	// proper behavior
	private void initialize(Context context) {
		edgePadding = getResources().getDimensionPixelSize(
				ResourceUtil.getDimenId("com_facebook_likeview_edge_padding"));
		internalPadding = getResources().getDimensionPixelSize(
				ResourceUtil
						.getDimenId("com_facebook_likeview_internal_padding"));
		if (foregroundColor == NO_FOREGROUND_COLOR) {
			foregroundColor = getResources()
					.getColor(
							ResourceUtil
									.getColorId("com_facebook_likeview_text_color"));
		}
	...
	private void initializeLikeButton(Context context) {
		likeButton = new LikeButton(context, likeActionController != null
				&& likeActionController.isObjectLiked());
		...
		socialSentenceView
				.setTextSize(
						...
						getResources()
								.getDimension(
										ResourceUtil
												.getDimenId("com_facebook_likeview_text_size")));
		...
		if (likeActionController != null) {
			...
			if (this.activity != null) {
				...
				if (context instanceof Activity) {
					...
					Context baseContext = ((ContextWrapper) context)
							.getBaseContext();
			...
			System.out
					.println("likeActionController.toggleLike(activity, parentFragment,getAnalyticsParameters());");
			likeActionController.toggleLike(activity, parentFragment,
	...
	private Bundle getAnalyticsParameters() {
		...
		params.putString(AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE,
				likeViewStyle.toString());
		params.putString(
		...
		params.putString(AnalyticsEvents.PARAMETER_LIKE_VIEW_OBJECT_ID,
				Utility.coerceValueIfNullOrEmpty(objectId, ""));
		params.putString(AnalyticsEvents.PARAMETER_LIKE_VIEW_OBJECT_TYPE,
				objectType.toString());
	...
	private void setObjectIdAndTypeForced(String newObjectId,
		...
		LikeActionController.getControllerForObjectId(newObjectId,
				newObjectType, creationCallback);
	}

	private void associateWithLikeActionController(
	...
	private void tearDownObjectAssociations() {
		...
		// If we were already waiting on a controller to be given back, make
		// sure we aren't waiting
		// anymore. Otherwise when that controller is given back to the
		// callback, it will go and
	...
	private void updateLikeStateAndLayout() {
		...
		if (likeActionController == null) {
			...
			socialSentenceView
					.setText(likeActionController.getSocialSentence());
	...
	private void updateLayout() {
		// Make sure the container is horizontally aligned according to
		// specifications.
		LayoutParams containerViewLayoutParams = (LayoutParams) containerView
				.getLayoutParams();
		LinearLayout.LayoutParams buttonLayoutParams = (LinearLayout.LayoutParams) likeButton
				.getLayoutParams();
		int viewGravity = horizontalAlignment == HorizontalAlignment.LEFT ? Gravity.LEFT
				: horizontalAlignment == HorizontalAlignment.CENTER ? Gravity.CENTER_HORIZONTAL
						: Gravity.RIGHT;
		...
		if (likeViewStyle == Style.STANDARD
				&& likeActionController != null
				&& !Utility.isNullOrEmpty(likeActionController
						.getSocialSentence())) {
		...
		LinearLayout.LayoutParams auxViewLayoutParams = (LinearLayout.LayoutParams) auxView
				.getLayoutParams();
		auxViewLayoutParams.gravity = viewGravity;

		containerView
				.setOrientation(auxiliaryViewPosition == AuxiliaryViewPosition.INLINE ? LinearLayout.HORIZONTAL
		...
		case TOP:
			auxView.setPadding(edgePadding, edgePadding, edgePadding,
					internalPadding);
			break;
		case BOTTOM:
			auxView.setPadding(edgePadding, internalPadding, edgePadding,
					edgePadding);
			break;
		case INLINE:
			if (horizontalAlignment == HorizontalAlignment.RIGHT) {
				auxView.setPadding(edgePadding, edgePadding, internalPadding,
						edgePadding);
			} else {
				auxView.setPadding(internalPadding, edgePadding, edgePadding,
						edgePadding);
			}
			break;
		}
	...
	private void updateBoxCountCaretPosition() {
		...
		case INLINE:
			likeBoxCountView
					.setCaretPosition(horizontalAlignment == HorizontalAlignment.RIGHT ? LikeBoxCountView.LikeBoxCountViewCaretPosition.RIGHT
	...
	private class LikeControllerBroadcastReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (extras != null) {
				// See if an Id was set in the broadcast Intent. If it was,
				// treat it as a filter.
				String broadcastObjectId = extras
						.getString(LikeActionController.ACTION_OBJECT_ID_KEY);
			...
			if (LikeActionController.ACTION_LIKE_ACTION_CONTROLLER_UPDATED
					.equals(intentAction)) {
				updateLikeStateAndLayout();
			} else if (LikeActionController.ACTION_LIKE_ACTION_CONTROLLER_DID_ERROR
					.equals(intentAction)) {
				if (onErrorListener != null) {
					onErrorListener.onError(NativeProtocol
							.getExceptionFromErrorData(extras));
				}
			} else if (LikeActionController.ACTION_LIKE_ACTION_CONTROLLER_DID_RESET
					.equals(intentAction)) {
	...
	private class LikeActionControllerCreationCallback implements
		...
		public void onComplete(LikeActionController likeActionController,
			...
			if (likeActionController != null) {
				...
				// Always associate with the controller, so it can get updates
				// if the view gets
				// enabled again.
	...
	public LikeActionController getLikeActionController() {
